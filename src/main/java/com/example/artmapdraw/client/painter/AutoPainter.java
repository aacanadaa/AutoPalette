package com.example.artmapdraw.client.painter;

import com.example.artmapdraw.client.palette.ArtMapPalette;
...
public class AutoPainter {
    ...
    private synchronized void loadRotationsIfNeeded() {
        ...
        eastRotations = loadRotationAsset("/assets/artmapdraw/east.ser");
        westRotations = loadRotationAsset("/assets/artmapdraw/west.ser");
        northRotations = loadRotationAsset("/assets/artmapdraw/north.ser");
        southRotations = loadRotationAsset("/assets/artmapdraw/south.ser");
    }
    ...
    private float[][][] loadRotationAsset(String resourcePath) {
        ...
        try (InputStream is = AutoPainter.class.getResourceAsStream(resourcePath)) {
            if (is == null) {
                System.err.println("[ArtMapDraw] Rotation asset not found: " + resourcePath);
                return rotations;
            }
