package com.example.artmapdraw.client.gui;

import com.example.artmapdraw.client.painter.AutoPainter;
...
public class DrawScreen extends Screen {
    ...
    public DrawScreen() {
        super(Text.literal("ArtMap Auto Draw Panel"));
    }
    ...
    private void refreshImageList() {
        imageFiles.clear();
        File folder = new File(MinecraftClient.getInstance().runDirectory, "config/artmapdraw/images");
        if (!folder.exists()) {
            folder.mkdirs();
        }
    ...
    private void loadSelectedImagePreview() {
        ...
        try {
            ...
            previewTexture = new NativeImageBackedTexture(() -> "artmapdraw_preview", previewImg);
            previewTextureId = Identifier.of("artmapdraw", "preview");
