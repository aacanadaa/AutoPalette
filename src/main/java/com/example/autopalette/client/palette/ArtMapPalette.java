package com.example.autopalette.client.palette;
...
public class ArtMapPalette {
    private static final String MAPPINGS_RESOURCE_PATH = "/assets/autopalette/mappings.json";
    ...
    private void loadPaletteFromResource() {
        ...
        itemMappings.put(14, "minecraft:white_dye");
        ...
        try (InputStream is = ArtMapPalette.class.getResourceAsStream(MAPPINGS_RESOURCE_PATH)) {
            if (is == null) {
                System.err.println("[AutoPalette] mappings.json resource not found!");
                return;
            }
            try (InputStreamReader isr = new InputStreamReader(is)) {
                ...
                for (String keyStr : versionObj.keySet()) {
                    ...
                    if (colorId != 0 && colorId != 8 && colorId != 36) {
